...
import com.androidmania.apps.profileapp.ControllerApp;
...
public class Register extends AppCompatActivity {
    ...
    private String url = ServerService.URL + "profiles";
    ...
    private void checkRegister(final String username, final String password, final String confirm_password) {
        ...
        ControllerApp.getInstance().addToRequestQueue(strReq, tag_json_obj);
    }
